...
pauseOnHover && "md:hover:[animation-play-state:paused]",
      ...
      >
        {items.map((item, idx) => (
          <li
  className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-8 py-6 transition-all duration-300 hover:scale-[1.03] hover:bg-gradient-to-br hover:from-[#00ffaa89] hover:via-[#00ff669c] hover:to-[#00ffcc83] md:w-[450px] dark:border-zinc-700 dark:bg-[linear-gradient(180deg,#27272a,#18181b)]"
              key={item.name}
          >
            <blockquote>
              <div
