...
const ContactPage = () => {
  return (
    <div className="">
      ...
      <Section 
      crosses
      className=" py-28 bg-black text-center text-white relative overflow-hidden">
      ...
      {/* Contact Section */}
      <Section id="contact" crosses className="py-24 bg-black border-t border-n-6">
          ...
          <div className="bg-gradient-to-br from-n-7 to-n-8 border border-n-6 p-10 lg:p-14 rounded-3xl text-white shadow-xl space-y-8 backdrop-blur">
            ...
            <div className="space-y-4 text-n-3 text-sm">
              ...
              <div>
                ...
                <p>
                  Support: <a href="mailto:contact@interfere.com" className="text-color-1">contact@wedgeai.com</a>
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="space-x-4">
                  <a href="https://x.com/wedgehealth" target="_blank" className="hover:text-zinc-600 duration-300">Twitter</a>
                  <a href="https://www.linkedin.com/company/wedge-ai/" target="_blank" className="hover:text-blue-600 duration-300">LinkedIn</a>
                </p>
              </div>
            </div>
          </div>
